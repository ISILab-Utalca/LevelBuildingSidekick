...
namespace GeneticSharp.Domain
{
    ...
    public interface IOperatorsStrategy
    {
        ...
        IList<IOptimizable> Cross(IPopulation population, ICrossover crossover, float crossoverProbability, IList<IOptimizable> parents);
        ...
        void Mutate(IMutation mutation, float mutationProbability, IList<IOptimizable> chromosomes);
    }
}
