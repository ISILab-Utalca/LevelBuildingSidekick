...
namespace Commons.Optimization.Evaluator
{
    ...
    public sealed class FitnessException : Exception
    {
        ...
        public FitnessException(IEvaluator fitness, string message)
        ...
        public FitnessException(IEvaluator fitness, string message, Exception innerException)
        ...
        public IEvaluator Fitness { get; private set; }
        #endregion
