...
namespace GeneticSharp.Domain
{
    ...
    public abstract class OperatorsStrategyBase : IOperatorsStrategy
    {
        ...
        public abstract IList<ChromosomeBase> Cross(IPopulation population, ICrossover crossover, float crossoverProbability, IList<ChromosomeBase> parents);
        ...
        public  abstract void Mutate(IMutation mutation, float mutationProbability, IList<ChromosomeBase> chromosomes);
        ...
        protected IList<ChromosomeBase> SelectParentsAndCross(IPopulation population, ICrossover crossover,
            float crossoverProbability, IList<ChromosomeBase> parents, int firstParentIndex)
        {
