...
namespace ISILab.LBS.Drawers
{
    ...
    [Drawer(typeof(ACO_BlueprintAssistant))]
    public class ACODrawer : Drawer
    {
        private readonly Vector2 nodeSize = new Vector2(100, 100);
        ...
        public override void Draw(object target, MainView view, Vector2 teselationSize)
        {
            ...
            // Set target Assitant
            var assistant = target as ACO_BlueprintAssistant;

            // Get modules
            var consts = assistant.Owner
                .GetModule<ConstrainsZonesModule>().Constraints;
            var zones = assistant.Owner
                .GetModule<SectorizedTileMapModule>().ZonesWithTiles;
