...
{
    public class PopulationAssistantPanel : VisualElement
    {
        #region UXMLFACTORY
        ...
        #region CONSTRUCTORS
        public PopulationAssistantPanel()
        {
            var visualTree = DirectoryTools.GetAssetByName<VisualTreeAsset>("PopulationAssistantPanel ");
