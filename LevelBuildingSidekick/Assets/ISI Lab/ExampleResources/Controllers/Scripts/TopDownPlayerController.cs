...
namespace ISILab.Examples
{
    ...
    public class TopDownPlayerController : MonoBehaviour
    {
        ...
        public Vector3 movementDirectionSmooth = Vector3.zero;
        ...
        public enum playerState { FreeRoam, Dashing };
        ...
        private void Update()
        {
            ...
            //Dash button
            if (Input.GetButtonDown("Fire3")) StartCoroutine(Dash());
        }
        ...
        private void CheckMovementInput()
        {
            ...
            movementDirection = inputDirection * movementSpeed;
            ...
            facingDirection.x = Mathf.Abs(movementDirectionSmooth.x) > movementSpeed * 0.025 ? inputDirection.x != 0 ? inputDirection.x : Mathf.Sign(movementDirectionSmooth.normalized.x) : inputDirection.x;
            facingDirection.z = Mathf.Abs(movementDirectionSmooth.z) > movementSpeed * 0.025 ? inputDirection.z != 0 ? inputDirection.z : Mathf.Sign(movementDirectionSmooth.normalized.z) : inputDirection.z;
