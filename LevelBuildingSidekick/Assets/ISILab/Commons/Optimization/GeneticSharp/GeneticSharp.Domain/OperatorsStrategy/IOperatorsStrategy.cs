...
namespace GeneticSharp.Domain
{
    ...
    public interface IOperatorsStrategy
    {
        ...
        IList<IEvaluable> Cross(IPopulation population, ICrossover crossover, float crossoverProbability, IList<IEvaluable> parents);
        ...
        void Mutate(IMutation mutation, float mutationProbability, IList<IEvaluable> chromosomes);
    }
}
