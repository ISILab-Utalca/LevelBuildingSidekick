...
namespace ISILab.Commons
{
    ...
    public static class Directions
    {
        ...
        {
            new Vector2Int(1, 1),    // Diagonal Upper Right
            new Vector2Int(-1, 1),   // Diagonal Upper Left
            new Vector2Int(-1, -1),  // Diagonal Lower Left
            new Vector2Int(1, -1)    // Diagonal Lower Right
        };
